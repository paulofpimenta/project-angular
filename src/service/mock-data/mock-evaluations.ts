...
export const EVALUATIONS: Evaluation [] = [
    ...
    new Evaluation(6.0,0.5,new Date("06 June 2016 13:09:00"), "Good", STUDENTS[5].id, ASSIGNMENTS[4].id),
    new Evaluation(4.0,0.5,new Date("07 June 2015 13:30:00"), "Very Good",STUDENTS[6].id, ASSIGNMENTS[5].id),
    ...
    new Evaluation(8.5,0.5,new Date("29 February 2015 13:30:00"), "Good", STUDENTS[4].id, ASSIGNMENTS[5].id),
];